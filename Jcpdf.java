    ...
    static public void main(String argv[]) {
        ...
        */
        ...
        /*using (Cpdf.Pdf pdf30 = Cpdf.fromFile("testinputs/cpdflibmanual.pdf", ""))
        {
            ...
            Cpdf.getDateComponents("D:20061108125017Z", ref year, ref month, ref day, ref hour, ref minute, ref second, ref hour_offset, ref minute_offset);
            ...
            string datestr = Cpdf.dateStringOfComponents(year, month, day, hour, minute, second, hour_offset, minute_offset);
            Console.WriteLine(datestr);
            Console.WriteLine("---cpdf_getPageRotation()");
            int rot = Cpdf.getPageRotation(pdf30, 1);
            Console.WriteLine($"/Rotate on page 1 = {rot}");
            Console.WriteLine("---cpdf_hasBox()");
            bool hasbox = Cpdf.hasBox(pdf30, 1, "/CropBox");
            ...
            Cpdf.getMediaBox(pdf30, 1, ref mb_minx, ref mb_maxx, ref mb_miny, ref mb_maxy);
            ...
            Cpdf.getCropBox(pdf30, 1, ref cb_minx, ref cb_maxx, ref cb_miny, ref cb_maxy);
            ...
            Cpdf.getBleedBox(pdf30, 1, ref bb_minx, ref bb_maxx, ref bb_miny, ref bb_maxy);
            ...
            Cpdf.getArtBox(pdf30, 1, ref ab_minx, ref ab_maxx, ref ab_miny, ref ab_maxy);
            ...
            Cpdf.getTrimBox(pdf30, 1, ref tb_minx, ref tb_maxx, ref tb_miny, ref tb_maxy);
            ...
            Cpdf.setMediabox(pdf30, Cpdf.all(pdf30), 100, 500, 150, 550);
            Console.WriteLine("---cpdf_setCropBox()");
            Cpdf.setCropBox(pdf30, Cpdf.all(pdf30), 100, 500, 150, 550);
            Console.WriteLine("---cpdf_setTrimBox()");
            Cpdf.setTrimBox(pdf30, Cpdf.all(pdf30), 100, 500, 150, 550);
            Console.WriteLine("---cpdf_setArtBox()");
            Cpdf.setArtBox(pdf30, Cpdf.all(pdf30), 100, 500, 150, 550);
            Console.WriteLine("---cpdf_setBleedBox()");
            Cpdf.setBleedBox(pdf30, Cpdf.all(pdf30), 100, 500, 150, 550);
            ...
            Cpdf.setPageLayout(pdf30, Cpdf.Layout.TwoColumnLeft);
            Console.WriteLine("---cpdf_setPageMode()");
            Cpdf.setPageMode(pdf30, Cpdf.PageMode.UseOutlines);
            ...
            byte[] metadata = Cpdf.getMetadata(pdf30);
            ...
            Cpdf.addPageLabels(pdf30, Cpdf.PageLabelStyle.UppercaseRoman, "PREFIX-", 1, Cpdf.all(pdf30), false);
            Console.WriteLine("---cpdf: get page labels");
            int pls = Cpdf.startGetPageLabels(pdf30);
            Console.WriteLine($"There are {pls} labels");
            for (int plsc = 0; plsc < pls; plsc++)
            {
                int style = Cpdf.getPageLabelStyle(plsc);
                string prefix = Cpdf.getPageLabelPrefix(plsc);
                int offset = Cpdf.getPageLabelOffset(plsc);
                int lab_range = Cpdf.getPageLabelRange(plsc);
            ...
            string pl = Cpdf.getPageLabelStringForPage(pdf30, 1);
